        ...
        ZStack(alignment: .leading) {
            VStack {
                ...
                VStack {
                    HStack {
                        ...
                        Text(weather.main.feels_like.roundDouble() + "ºc")
                            .font(.system(size: 60))
                            .fontWeight(.bold)
                            .padding()
                    }
            ...
            VStack {
                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    HStack {
                        WeatherRow(logo: "thermometer", name: "Min temp", value:(weather.main.temp_min.roundDouble() + "ºc"))
                        Spacer()
                        WeatherRow(logo: "thermometer", name: "Max temp", value:(weather.main.temp_max.roundDouble() + "ºc"))
                    ...
                    .padding()
                    .padding(.bottom, 20)
                    .foregroundColor(Color(hue: 0.613, saturation: 0.96, brightness: 0.303))
                    .background(.white)
